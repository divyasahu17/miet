            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <div style={{
                ...
                {[
                  ...
                  { name: t('links.consultantslogin'), href: '/consultants/login' },
                  { name: t('links.consultantssignup'), href: '/consultants/signup' }
                ].map((link) => (
                  <a
                    key={link.name}
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  📞 <a href="tel:+919319027664" style={{ color: 'inherit', textDecoration: 'none' }}>+91 9319027664</a>
                </div>
                <div style={{
                  fontSize: 'clamp(1rem, 1.1vw, 1.05rem)',
                  color: 'rgba(255,255,255,0.9)',
                  ...
                  ✉️ <a href="mailto:miet.life@gmail.com" style={{ color: 'inherit', textDecoration: 'none' }}>miet.life@gmail.com</a>
                </div>
