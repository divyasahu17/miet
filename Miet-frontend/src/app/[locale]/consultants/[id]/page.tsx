  ...
  useEffect(() => {
    const fetchConsultant = async () => {
      ...
      try {
        ...
        const consultant = allConsultants.find((c: any) => c.id === parseInt(params.id as string) && isConsultantApproved(c));
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div>
              ...
              {/* Platform Support and City Info */}
              <div style={{
                background: "var(--muted)",
                borderRadius: "12px",
                padding: "1.5rem",
                ...
                <div style={{ borderBottom: '1px solid var(--border)', paddingBottom: '1rem' }}>
                  <h3 style={{ fontSize: '16px', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '0.75rem' }}>Platform Support</h3>
                  <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
                    <a href="mailto:miet.life@gmail.com" style={{ display: "flex", alignItems: "center", gap: "0.75rem", textDecoration: "none" }}>
                      <span style={{ color: "#5a67d8", fontSize: "18px" }}>📧</span>
                      <div>
                        <div style={{ fontWeight: 600, color: "var(--text-primary)", fontSize: '14px' }}>Email Support</div>
                        <div style={{ color: "#5a67d8", fontSize: "13px" }}>miet.life@gmail.com</div>
                      </div>
                    </a>
                    <a href="tel:+919319027664" style={{ display: "flex", alignItems: "center", gap: "0.75rem", textDecoration: "none" }}>
                      <span style={{ color: "#5a67d8", fontSize: "18px" }}>📞</span>
                      <div>
                        <div style={{ fontWeight: 600, color: "var(--text-primary)", fontSize: '14px' }}>Phone Support</div>
                        <div style={{ color: "#5a67d8", fontSize: "13px" }}>+91 9319027664</div>
                      </div>
                    </a>
                  </div>
                </div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                  <span style={{ color: "#5a67d8", fontSize: "18px" }}>🏙️</span>
                  <div>
                    <div style={{ fontWeight: 600, color: "var(--text-primary)", fontSize: '14px' }}>City</div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                  <span style={{ color: "#5a67d8", fontSize: "18px" }}>💻</span>
                  <div>
                    <div style={{ fontWeight: 600, color: "var(--text-primary)", fontSize: '14px' }}>Service Mode</div>
                    <div style={{ color: "var(--text-secondary)", fontSize: "13px" }}>
                      {consultant.mode}
                    </div>
                  </div>
