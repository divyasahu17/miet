...
async function setupDatabase() {
  ...
  try {
    ...
    if (subCols.length > 0) {
      if (!subCols.some(c => c.name === 'target_audience')) {
      ...
      if (!subCols.some(c => c.name === 'features_json')) {
        await db.exec(`ALTER TABLE subscription_plans ADD COLUMN features_json TEXT DEFAULT '{}'`);
        console.log(`✅ Auto-migrated: Added features_json column to subscription_plans`);
      }
    }
  } catch (err) {
...
const CMS_DEFAULT_SECTIONS = {
  ...
  about: ['AboutPage', 'tabs', 'overview', 'founder', 'vision', 'team', 'programmes'],
...
const CMS_DEFAULT_CONTENT_RAW = {
  ...
  tabs: { overview: 'Overview', vision: 'Vision', founder: 'Founder', team: 'Team', programmes: 'Programmes' },
  overview: { title: 'Comprehensive Support for Special Education and Mental Health Challenges', description1: 'We provide best <b>specialized education services</b> for children with <b>unique needs</b> & services to address <b>Mental Health Challenges</b>.', communityTitle: 'Join Our Community of Special Educators & Counsellors', communityDescription: 'Discover the latest research, strategies & tools for teaching students with diverse learning needs. MieT is right place for guardian of a child with special needs, student persuing Special Education or Psychology, technology enthusiast, experienced Special Educator or Counsellor!', aboutTitle: 'About MieT (मीत)', aboutIntro: '<b>Introducing MieT (मीत): Your Trusted Partner in Inclusion, Special Education, and Mental Health</b>', aboutDesc1: 'Based in Gurgaon, MieT is a tech-enabled platform committed to empowering individuals with diverse abilities through personalized Special Education, Mental Health Services and Counselling. Our mission is to unlock potential, nurture growth and build an inclusive community of caregivers, educators, and professionals.', aboutDesc2: 'We offer comprehensive support through customized care plans, emotional well-being services, social communication coaching and career guidance—ensuring holistic development for every individual. At MieT, education meets empathy and care meets innovation.', joinUs: 'Join us in creating a world where everyone has the opportunity to thrive.', tags: 'Best Reviews · Special Education · Mental Health · Counselling · Assessment · Delhi NCR · Gurgaon · Online · Offline', image: '', video: '', youtubeUrl: 'https://www.youtube.com/embed/hQFG_yXbmIM' },
  vision: { title: 'Our Vision', p1: 'At MieT (मीत), we envision a world where inclusion is not an exception but a standard—where every individual, regardless of ability, feels a sense of belonging, purpose and dignity. Our vision is to create a compassionate, tech-enabled ecosystem that celebrates neurodiversity and supports individuals with disabilities through accessible education, mental health services, and counselling.', p2: 'We aspire to build a future where children and adults with diverse abilities are not only supported but empowered to realize their full potential. By removing barriers to learning, communication and social participation, we aim to ensure equal access to opportunities in education, employment, and everyday life.', p3: 'Through collaboration with families, professionals and communities, MieT seeks to foster a culture of understanding and acceptance. We are dedicated to being a trusted friend—a मीत—on every individual\'s journey toward self-reliance, emotional well-being and a more inclusive society.', tags: 'Top ranking · Best reviews · Jyoti Bajaj · Best Special Educator · Mental Health · Gurgaon · Delhi NCR · DPS', image: '' },
  founder: { title: 'Our Founder & Chief Curator', p1: '<b>Dr. Jyoti Bajaj</b> is the Founder and Chief Curator of MieT. She is a compassionate professional with over 15 years of dedicated service in Physiotherapy, Special Education, and Counselling. Dr. Bajaj has led special education, inclusion and counselling in institutions like St Mary\'s School, Venkateshwar Global School, Delhi Public School (Rohini/ Gurgaon). She is deeply committed to supporting children with special needs, helping them thrive physically, academically, and emotionally.', p2: 'Her extensive background in physiotherapy enables her to provide specialized care and rehabilitation for children, enhancing their physical well-being and mobility. As a special educator, she understands the unique learning needs and challenges faced by individuals with special needs and thus tailors programmes to ensure their success. Her skills as a counsellor allow her to offer empathetic and effective support, addressing the emotional and mental health needs of individuals and their families.', p3: 'Dr. Bajaj is a Gold Medalist in Special Education from Delhi University, Gold Medallist in Physiotherapy from Kurukshetra University and distinction holder in Guidance and Counselling.', writeToUs: 'Write to us', image: '', linkedin: '', instagram: '', facebook: '', twitter: '' },
  team: { title: 'Our Team', description: 'Our team includes special education teachers, Occupational Therapists, Speech Therapists, Behavior analysts, and other professionals, all with a passion for helping children with special needs. We believe in ongoing professional development to ensure that our team stays up-to-date with the latest research and best practices.', meetTeam: 'Meet Our Team' },
  programmes: { title: 'Our Programmes', p1Title: 'Special Education', p1Desc: 'We offer a comprehensive range of <b>special education</b> programmes in <b>Gurgaon</b>, including early intervention, preschool, elementary, middle, and high school programmes, as well as special needs education, counselling services, and transition services. Each programme is designed to meet the unique needs of every child, supporting their mental health and developmental goals while helping them reach their full potential through individualized care and learning.', p2Title: 'Mental Health', p2Desc: 'At MieT, we take a <b>holistic approach to mental health</b>, focusing on <b>mental health counselling services</b> in <b>Gurgaon</b> to address diverse challenges. We design tailored intervention plans that are consistently monitored to ensure progress in achieving developmental milestones. Our motto is to promote <b>self-reliance, social inclusion</b>, and empowerment for individuals with diverse abilities, supporting their journey toward better mental health and overall well-being.' },
